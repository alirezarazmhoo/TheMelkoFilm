...
var FirstTr = null;
var LastTr = null;
function tableCity(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="tableCityy" class="table  text-center table-striped table-bordered table-sm" ><thead ><tr>';
    ...
    //}
            ...
            _table += '<td class="text-center">امکانات</td>';
    ...
    for (var i in ListData) {
        ...
        //}
            ...
            listtd += '<td id="mytd" style=""><button data-number="0"  type="button" id="btnRegister" data-toggle="modal" data-target="#RemoveModal" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;حذف</button>    <button data-number="1" type="button" id="btnRegister" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;ویرایش</button></td>';
