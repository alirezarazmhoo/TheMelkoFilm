...
var FirstTr = null;
var LastTr = null;
function tableJobAdmin(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="AdminJobActivity"  class="table table-striped table-bordered table-sm" cellspacing="0""><thead><tr>';
