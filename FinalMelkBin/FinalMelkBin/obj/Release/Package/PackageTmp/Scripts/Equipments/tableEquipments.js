...
var FirstTr = null;
var LastTr = null;
function tableEquipments(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="TableEqouipment"  class="table text-center table-striped table-bordered table-sm" cellspacing="0""><thead><tr>';
