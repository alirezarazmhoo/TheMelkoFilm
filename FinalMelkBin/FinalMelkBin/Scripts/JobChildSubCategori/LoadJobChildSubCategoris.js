/// <reference path="tablejoobchildsubcategoris.js" />
...
function LoadJobChildSubCategori() {
    MyAjax("Get", "GetJobChildSubCategoriInfo", { 'description': Description.value }, function (listdata) {

        ListDownCategori = listdata;
        tablejoobChildSubCategori(listdata, divdownCat, [{ Data: "ID", Title: "ID" }, { Data: "CategoriName", Title: "گروه اصلی " }, { Data: "SubCategori", Title: "زیردسته اول" }, { Data: "ChildSubCategori", Title: "زیردسته دوم" }], [{ Text: "RemoveCity", classname: "danger", Icon: "remove", Event: Removeee }, { Text: "EditCity", classname: "primary", Icon: "edit", Event: edit }], { IsRowNumber: true, IsSelected: true });

    });
}
function Removeee(id) {
    if ($('#OkButtun').click(function () {
        MyAjax("Post", "JobChildSubCatDel", { "id": id }, function (Data) {
