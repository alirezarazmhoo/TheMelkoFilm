...
var FirstTr = null;
var LastTr = null;
function tablejoobChildSubCategori(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="tableChildSubCat"  class="table table-striped table-bordered table-sm text-center"><thead><tr>';
