...
var FirstTr = null;
var LastTr = null;
function tableCategori(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="tableCategori"   class="table text-center table-striped table-bordered table-sm" cellspacing="0""><thead><tr>';
