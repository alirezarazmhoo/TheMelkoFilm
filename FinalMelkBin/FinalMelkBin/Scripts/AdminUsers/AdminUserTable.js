...
var FirstTr = null;
var LastTr = null;
function tableAdminUser(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="TableAdminUser"  class="table text-center table-striped table-bordered table-sm" cellspacing="0""><thead><tr>';
    ...
    for (var i in ListData) {
        ...
        //}
        listtd += '<td><button data-number="0" type="button" id="btnRegister" data-toggle="modal" data-target="#RemoveModal" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;حذف</button> <button data-number="1" type="button" id="btnRegister" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;ویرایش</button>  <button data-number="2" type="button" id="btnRegister" class="btn btn-warning" ><span class="glyphicon glyphicon-eye"></span>&nbsp;&nbsp;دسترسی موجود</button>  <button data-number="3" type="button" id="btnstatusRegister" class="btn btn-info" data-toggle="modal" data-target="#StatusModal"><span class="glyphicon glyphicon-eye" ></span>&nbsp;&nbsp;تخصیص نقش</button></td>';
