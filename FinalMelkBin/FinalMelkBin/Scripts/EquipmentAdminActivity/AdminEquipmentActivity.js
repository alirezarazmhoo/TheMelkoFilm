...
var FirstTr = null;
var LastTr = null;
function tableEquipmentAdmin(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="EquipmentActivity"  class="table text-center table-striped table-bordered table-sm" cellspacing="0""><thead><tr>';
