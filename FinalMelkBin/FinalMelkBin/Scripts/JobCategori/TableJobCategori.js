...
var FirstTr = null;
var LastTr = null;
function tableJobCategori(ListData, Content, Columns, Buttons, option) {

    if (ListData == null || ListData.length == 0) {
        return "";
    }
    var _table = '<table id="JobTable"  class="table text-center table-striped table-bordered table-sm text-center"><thead><tr>';
    ...
    for (var i in Columns) {
        ...
        _table += '<td class="text-center">' + Columns[i].Title + '</td>';
    }
    //if (Buttons != null) {
